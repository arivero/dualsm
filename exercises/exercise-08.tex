  ...
  \item \textbf{[10 marks]}
    ...
    \begin{enumerate}[label=(\roman*)]
      ...
      \item Can a \textbf{single} value of $\epsilon$ simultaneously
        ...
        (Note: the hierarchy parameter $\varepsilon$ absorbs O(1) coefficients from the scalar potential; your answer should identify the parametric scaling, not a unique numerical value.)
    \end{enumerate}
