...
The following connection between complementarity and duality is \emph{motivational} --- it identifies structural similarities that suggest the duality interpretation, but does not constitute an independent derivation.
