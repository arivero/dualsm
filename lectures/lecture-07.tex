...
$\Phi_H$ is a four-fermion composite.  \textbf{The Higgs field is not
an elementary scalar}---it is a deeply composite state of the electric
...
The magnetic quarks $q$, $\widetilde{q}$ are identified with the SM
...
\begin{remark}[No elementary scalars in the electric theory]
  ...
  The Higgs doublets of the SM are composites
  $\Phi_H = \langle \widetilde{Q}\lambda\lambda Q \rangle$
...
\begin{enumerate}
  ...
  \item \textbf{Electric theory:}
    ...
    adjoint---\emph{no elementary scalars}.  All scalars in the
