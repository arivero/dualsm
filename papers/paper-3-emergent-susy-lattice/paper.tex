...
observables that sharply discriminate between the two scenarios, derive
...
$\Nf = 8$ at the lightest available fermion masses.  This is strikingly
close to the emergent-SUSY prediction of unity, and is in tension with
the ordinary confining prediction $m_\sigma/m_\pi \gg 1$.  However, the
...
Sannino~\cite{AMPS2013} makes sharp, quantitative predictions: a mass
...
The predictions in this paper are the sharpest available consequences
of that conjecture, and the proposed measurement programme is designed
to test it decisively.  A positive result would be extraordinary:
