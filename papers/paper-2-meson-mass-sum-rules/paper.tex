...
%% ---------- Title ----------
\title{\textbf{Dual Meson Mass Sum Rules from the $6 \times 6$ Flavour Matrix}}
...
PDG~2024 data.  We find that sum rules~I--IV are consequences of
standard QCD symmetries (chiral symmetry and heavy quark symmetry)
and are well satisfied, while sum rules~V--VI encode the additional
structure of the scalar democracy framework and provide non-trivial
consistency checks of the dualised SM at the $\sim 10\%$ level.
\end{abstract}
