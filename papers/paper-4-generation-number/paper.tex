...
conformal window, ruling out higher-$k$ adjoint deformations.  The
three-generation structure of the Standard Model is therefore the unique
...
The intersection of the SU and Sp bounds uniquely selects
\begin{equation}
  \boxed{\ngen = 3}\,.
\end{equation}
